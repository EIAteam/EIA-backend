    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projectState', models.CharField(blank=True, max_length=10, null=True, verbose_name='')),
                ('projectType', models.CharField(blank=True, max_length=10, null=True, verbose_name='项目类型')),
