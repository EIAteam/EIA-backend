# Generated by Django 2.0.2 on 2018-04-27 06:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exhaustGasMaterials', models.TextField(blank=True, default='[{}]', null=True, verbose_name='废气材料信息')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fileType', models.CharField(blank=True, choices=[('businessLicenseFile', '营业执照复印件'), ('idCardFile', '法人身份证复印件'), ('workshopLeaseContractFile', '厂房租赁合同复印件'), ('siteUseFile', '场地使用证明复印件'), ('environmentalProtectionCertificate', '环保证'), ('workshopEastImg', '厂址四至图-东'), ('workshopSouthImg', '厂址四至图-南'), ('workshopWestImg', '厂址四至图-西'), ('workshopNorthImg', '厂址四至图-北'), ('processFlowChart', '工艺流程图'), ('planeLayoutChart', '平面布置图'), ('satelliteInformationChart', '卫星信息图'), ('firstEIAReport', '环评报告初稿'), ('basicInfoFile', '基础信息表'), ('exhaustGasInfoFile', '废气信息表'), ('firstEIAReport', '环评报告终稿')], max_length=255, null=True, verbose_name='文件类型')),
