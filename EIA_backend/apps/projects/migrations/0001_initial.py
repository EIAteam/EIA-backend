    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projectStatus', models.CharField(blank=True, choices=[('none', '无'), ('receivedInfo', '收到资料'), ('reportEdit', '报告编写'), ('InfoComplete', '资质材料完善'), ('submit', '入件'), ('investigate', '审批修改'), ('takeEvidence', '取证')], default='none', max_length=255, null=True, verbose_name='项目状态')),
                ...
                ('projectType', models.CharField(blank=True, choices=[('none', '无'), ('newBuilt', '新建'), ('extension', '扩建'), ('removal', '搬迁')], default='none', max_length=255, null=True, verbose_name='项目性质')),
