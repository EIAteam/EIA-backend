# Generated by Django 2.0.3 on 2018-04-04 09:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.FileField(blank=True, null=True, upload_to=projects.models.BusinessLicenseFile.uploadFilePath, verbose_name='营业执照复印件')),
            ],
        ),
        migrations.CreateModel(
            name='IdCardFile',
            fields=[
                ...
                ('url', models.FileField(blank=True, null=True, upload_to=projects.models.IdCardFile.uploadFilePath, verbose_name='法人身份证复印件')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='文件名')),
                ('url', models.FileField(blank=True, null=True, upload_to=projects.models.SiteUseFile.uploadFilePath, verbose_name='场地使用证明复印件')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='siteUseFile', to='projects.Project')),
            ],
        ),
        migrations.CreateModel(
            name='WorkshopEastImg',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='文件名')),
                ('url', models.FileField(blank=True, null=True, upload_to=projects.models.WorkshopEastImg.uploadFilePath, verbose_name='厂址四至图-东')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workshopEastImg', to='projects.Project')),
            ],
        ),
        migrations.CreateModel(
            name='WorkshopLeaseContractFile',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='文件名')),
                ('url', models.FileField(blank=True, null=True, upload_to=projects.models.WorkshopLeaseContractFile.uploadFilePath, verbose_name='厂房租赁合同复印件')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workshopLeaseContractFile', to='projects.Project')),
            ],
        ),
        migrations.CreateModel(
            name='WorkshopNorthImg',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='文件名')),
                ('url', models.FileField(blank=True, null=True, upload_to=projects.models.WorkshopNorthImg.uploadFilePath, verbose_name='厂址四至图-北')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workshopNorthImg', to='projects.Project')),
            ],
        ),
        migrations.CreateModel(
            name='WorkshopSouthImg',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='文件名')),
                ('url', models.FileField(blank=True, null=True, upload_to=projects.models.WorkshopSouthImg.uploadFilePath, verbose_name='厂址四至图-南')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workshopSouthImg', to='projects.Project')),
            ],
        ),
        migrations.CreateModel(
            name='WorkshopWestImg',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='文件名')),
                ('url', models.FileField(blank=True, null=True, upload_to=projects.models.WorkshopWestImg.uploadFilePath, verbose_name='厂址四至图-西')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workshopWestImg', to='projects.Project')),
            ],
        ),
        migrations.AddField(
            model_name='idcardfile',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='idCardFile', to='projects.Project'),
        ),
        migrations.AddField(
            model_name='businesslicensefile',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='businessLicenseFile', to='projects.Project'),
        ),
    ]
