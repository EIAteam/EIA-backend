...
class Project(models.Model):
    ...
    environmentalEffectclassification = models.CharField(blank=True, max_length=255, default='[]', null=True,
                                                         verbose_name="环境影响评价行业类别")
    ...
    energyUsage = models.CharField(blank=True, max_length=255, null=True, choices=ENERGYUSAGE_CHOICES,
                                   verbose_name="能源使用情况")
    ...
    emissionStandard = models.TextField(null=True,
                                        ...
                                        verbose_name='废弃排放标准')
    environmentalEngineering = models.TextField(null=True, default='[{"project":"环保工程","content":"","use":""}]',
                                                verbose_name='环保工程')
